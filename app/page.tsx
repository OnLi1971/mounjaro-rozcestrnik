...
export default function Home() {
  console.log("Rendering home page with tools:", tools.length)
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto" data-macaly="subtitle">
            Vyberte si z nabídky užitečných nástrojů a kalkulaček pera Mounjaro
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {tools.map((tool, index) => {
            ...
            console.log("Rendering tool:", tool.title)
              ...
              <Card key={index} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 bg-white border-gray-200" data-macaly={`tool-card-${index}`}>
                ...
                <CardContent className="pt-0">
                  <Button 
                    ...
                    onClick={() => console.log("Opening tool:", tool.title)}
                  >
                    <a 
                      href={tool.href} 
                      target="_blank" 
